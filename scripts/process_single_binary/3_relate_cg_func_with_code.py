...
class FunctionInlineReplacer:
    ...
    def inline_function_calls(self, target_func_name: str) -> Dict[str, Any]:
        ...
        if "callee_internal" in func_data:
            callees = func_data["callee_internal"]
            if isinstance(callees, list):
                callees_to_inline.extend(callees)

        if "caller" in func_data:
            callers = func_data["caller"]
        ...
        for callee_name in callees_to_inline:
            ...
            callee_code = callee_data['code']
    
            stripped_callee_name = func_data['stripped_function_name']
        ...
        func_data["callee_internal"] = inlined_callee_codes
        func_data["caller"] = inlined_caller_code
