...
VLLM_API_URL = " "      # You must first enable vLLM for the LoRA model.
VLLM_MODEL_NAME = " "   # Model Name，eg: "codellama-lora"
MAX_CONCURRENT_REQUESTS = 64  # Control concurrent requests to prevent OOM
TIMEOUT = 600

class VLLMAPIClient:
    def __init__(self, api_url: str = VLLM_API_URL, lora_name: str = VLLM_MODEL_NAME, max_concurrent: int = MAX_CONCURRENT_REQUESTS, timeout: int = TIMEOUT):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o","--output-file", type=str, default="", required=True,
